...
def modifyFiles(file_path, file_name,extension):
    ...
    with open(file_path+"\\"+file_name+'_modified'+extension, 'w', encoding = 'utf-8') as file:
...
def main():
    ...
    import os
    path_without_name, file_name = os.path.split(file_path)
    file_name, file_extension = os.path.splitext(file_name)

    modifyFiles(path_without_name, file_name, file_extension)
